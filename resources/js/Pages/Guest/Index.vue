...
<template>
    <div
        id="hero"
        class="relative z-0 bg-[url('/hero.jpg')] bg-cover bg-center h-[770px]"
    >
        <div
            id="mask"
            class="absolute top-0 left-0 z-0 w-full h-full bg-black opacity-80"
        ></div>
        <div class="relative z-10 h-full">
            <Container class="flex flex-col justify-between h-full">
                <Header />
                ...
                <div
                    class="flex items-center justify-center py-6 -mb-12"
                    style="
                ...
                >
                    ...
                    <div class="">
                        ...
                        <p>Scegli il piano Standard con pubblicità.</p>
                    </div>
                </div>
            </Container>
        </div>
    ...
    <section class="mt-12 py-9 section-border">
        <Container class="lg:flex">
            <div
                class="flex flex-col justify-center w-1/2 text-center lg:text-start"
            >
                <p class="text-5xl font-bold mb-9">
                    Goditi Netflix sulla tua TV
                </p>
                <p class="text-3xl">
                    Guarda Netflix su smart TV, Playstation, Xbox,
                    <br class="none lg:block" />
                    Chromecast, Apple TV, lettori Blu-ray e molti altri
                    dispositivi.
                </p>
            </div>
            <div class="w-1/2 p-5">
                <Image src="/images/index/tv.png" alt="Tv" />
            </div>
        </Container>
    </section>
    ...
    <section class="section-border py-9">
        <Container class="lg:flex">
            <div class="w-1/2 p-5">
                <Image src="/images/index/device-pile.png" alt="Tv" />
            </div>
            <div
                class="flex flex-col justify-center w-1/2 text-center lg:text-start"
            >
                <p class="text-5xl font-bold mb-9">Guarda Netflix ovunque</p>
                <p class="text-3xl">
                    Cellulare, tablet, laptop e TV: scegli tu cosa usare per
                    guardare in streaming film e serie TV senza limiti.
                </p>
            </div>
        </Container>
    </section>
            ...
            <Container class="lg:flex">
                ...
                >
                    ...
                    <p class="text-3xl">
                        ...
                        personaggi preferiti in uno spazio tutto loro già
                        incluso nel tuo abbonamento.
                    </p>
                </div>
                <div class="w-1/2 p-5">
                    <Image src="/images/index/bambini.png" alt="Tv" />
                </div>
            </Container>
        </Container>
    </section>
    ...
    <section class="section-border py-9">
        <Container>
            <Container class="lg:flex">
                <div class="w-1/2 p-5">
                    <Image src="/images/index/mobile.jpg" alt="Tv" />
                </div>
                <div
                    class="flex flex-col justify-center w-1/2 text-center lg:text-start"
                >
                    ...
                    <p class="text-3xl">
                        Guarda in aereo, sul treno, in astronave...
                    </p>
                </div>
            </Container>
        </Container>
...
<style scoped>
.section-border {
    border-bottom: 8px solid #86868646;
}
</style>
